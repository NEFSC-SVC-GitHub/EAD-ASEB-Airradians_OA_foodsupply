...
Total_KWmod_0914 <- kruskal.test(CR_mL.hr.bfactor ~pCO2, data = Total_FR_914_df.bfactor) # run mod
pander(print(Total_KWmod_0914), style='rmarkdown') # table for SRH test
...
pander(print(Chaet_KWmod_0914), style='rmarkdown') # table for K test
# | Test statistic | df | P value |
# |:--------------:|:--:|:-------:|
...
shapiro.test(resid(Total_AOVmod_0930)) # 2.129e-08
leveneTest(Total_AOVmod_0930) # 0.08744 .
...
shapiro.test(resid(Ply_AOVmod_0930)) #  5.133e-05
leveneTest(Ply_AOVmod_0930) # 0.9666
# need to run the non parametric Scheirer-Ray-Hare Test
...
shapiro.test(resid(Total_AOVmod_1026)) # 0.1277
leveneTest(Total_AOVmod_1026) # 0.02123 *
# need to run the non parametric Scheirer-Ray-Hare Test
...
# |       &nbsp;       | Df | Sum Sq  |     H     | p.value  |
# |:------------------:|:--:|:-------:|:---------:|:--------:|
# |      **pCO2**      | 1  |  45.68  |  0.7251   |  0.3945  |
# |   **Fed_Unfed**    | 1  |  664.4  |   10.55   | 0.001164 |
# | **pCO2:Fed_Unfed** | 1  | 0.02012 | 0.0003194 |  0.9857  |
# |   **Residuals**    | 23 |  972.1  |    NA     |    NA    |
...
shapiro.test(resid(Ply_AOVmod_1026)) # 0.4122
leveneTest(Ply_AOVmod_1026) # 0.001524  ***
# need to run the non parametric Scheirer-Ray-Hare Test
...
# |       &nbsp;       | Df | Sum Sq |    H    | p.value |
# |:------------------:|:--:|:------:|:-------:|:-------:|
# |      **pCO2**      | 1  | 18.46  | 0.2098  | 0.6469  |
# |   **Fed_Unfed**    | 1  | 545.9  |  6.203  | 0.01275 |
# | **pCO2:Fed_Unfed** | 1  | 0.9111 | 0.01035 |  0.919  |
# |   **Residuals**    | 28 |  2172  |   NA    |   NA    |
