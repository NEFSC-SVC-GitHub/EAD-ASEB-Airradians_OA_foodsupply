...
# |:-------------:|:--:|:------:|:-------:|:-------:|:--------:|
# |   **pCO2**    | 1  | 400.8  |  400.8  |  13.13  | 0.002766 |
# | **Residuals** | 14 | 427.3  |  30.52  |   NA    |    NA    |
kable(as.data.frame(anova(Total_AOVmod_0914))) %>%  # print a png of this table
  kable_styling() %>%
...
# |   pCO2   | Fed_Unfed | N  | CR_mL.hr.mmlength |  sd   |   se   |  ci   |
# |:--------:|:---------:|:--:|:-----------------:|:-----:|:------:|:-----:|
# | 500 μatm |    fed    | 15 |       6.461       | 6.868 | 1.773  | 3.803 |
# | 500 μatm |   unfed   | 12 |       1.435       | 2.005 | 0.5789 | 1.274 |
...
# |   pCO2   | Fed_Unfed | N  | CR_mL.hr.bfactor |  sd   |  se   |  ci   |
# |:--------:|:---------:|:--:|:----------------:|:-----:|:-----:|:-----:|
# | 500 μatm |    fed    | 15 |      17.17       | 16.47 | 4.253 | 9.121 |
# | 500 μatm |   unfed   | 12 |      4.844       | 6.058 | 1.749 | 3.849 |
...
# |   pCO2   | Fed_Unfed | N  | CR_mL.hr.bfactor |  sd   |  se   |  ci   |
# |:--------:|:---------:|:--:|:----------------:|:-----:|:-----:|:-----:|
# | 500 μatm |    fed    | 4  |      16.07       | 17.71 | 8.856 | 28.18 |
# | 500 μatm |   unfed   | 1  |      16.04       |  NA   |  NA   |  NA   |
...
shapiro.test(resid(Total_AOVmod_0930)) # 1.282e-07
leveneTest(Total_AOVmod_0930) # 0.1185
# need to run the non parametric Scheirer-Ray-Hare Test
Total_SRHmod_0930 <- scheirerRayHare(CR_mL.hr.bfactor ~ pCO2 * Fed_Unfed,
                      data=Total_FR_930_df.bfactor)
pander(print(Total_SRHmod_0930), style='rmarkdown') # table for SRH test
# |       &nbsp;       | Df | Sum Sq |   H    | p.value |
# |:------------------:|:--:|:------:|:------:|:-------:|
# |      **pCO2**      | 1  | 272.2  | 0.9882 | 0.3202  |
# |   **Fed_Unfed**    | 1  |  2654  | 9.634  | 0.00191 |
# | **pCO2:Fed_Unfed** | 1  | 318.6  | 1.157  | 0.2822  |
# |   **Residuals**    | 53 | 12100  |   NA   |   NA    |
kable(as.data.frame(print(Total_SRHmod_0930))) %>%  # print a png of this table
  kable_styling() %>%
  save_kable(file = "C:/Users/samjg/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/ClearanceRates/20210930_figs_tables/20210930_Total_CR_SRH_Table.png", zoom = 1.5)
...
leveneTest(Ply_AOVmod_0930) # 0.723
...
leveneTest(Chaet_AOVmod_0930) #0.1219
# need to run the non parametric Scheirer-Ray-Hare Test
...
# |   pCO2   | Fed_Unfed | N  | CR_mL.hr.mmlength |   sd   |  se   |   ci   |
# |:--------:|:---------:|:--:|:-----------------:|:------:|:-----:|:------:|
# | 500 μatm |    fed    | 8  |       12.72       | 3.775  | 1.335 | 3.156  |
# | 500 μatm |   unfed   | 1  |       0.658       |   NA   |  NA   |   NA   |
# | 800 μatm |    fed    | 10 |       17.96       | 13.83  | 4.373 | 9.892  |
# | 800 μatm |   unfed   | 7  |       1.46        | 0.9789 | 0.37  | 0.9054 |
...
# |   pCO2   | Fed_Unfed | N  | CR_mL.hr.bfactor |  sd   |  se   |  ci   |
# |:--------:|:---------:|:--:|:----------------:|:-----:|:-----:|:-----:|
# | 500 μatm |    fed    | 8  |      63.17       | 23.53 | 8.32  | 19.67 |
# | 500 μatm |   unfed   | 1  |      11.88       |  NA   |  NA   |  NA   |
# | 800 μatm |    fed    | 10 |      99.59       | 65.21 | 20.62 | 46.65 |
# | 800 μatm |   unfed   | 7  |      18.58       | 13.5  | 5.104 | 12.49 |
...
Total_AOVmod_1026 <-aov(CR_mL.hr.bfactor ~ pCO2 * Fed_Unfed,
                      data=Total_FR_1026_df.bfactor) 
shapiro.test(resid(Total_AOVmod_1026)) # 0.1179
leveneTest(Total_AOVmod_1026) # 0.01947 *
# need to run the non parametric Scheirer-Ray-Hare Test
Total_SRHmod_1026 <- scheirerRayHare(CR_mL.hr.bfactor ~ pCO2 * Fed_Unfed,
                      data=Total_FR_1026_df.bfactor)
pander(print(Total_SRHmod_1026), style='rmarkdown') # table for SRH test
# |       &nbsp;       | Df | Sum Sq |    H    | p.value  |
# |:------------------:|:--:|:------:|:-------:|:--------:|
# |      **pCO2**      | 1  |  33.7  | 0.5761  |  0.4479  |
# |   **Fed_Unfed**    | 1  | 596.5  |  10.2   | 0.001407 |
# | **pCO2:Fed_Unfed** | 1  | 3.964  | 0.06776 |  0.7946  |
# |   **Residuals**    | 22 | 858.6  |   NA    |    NA    |
  kable(as.data.frame(print(Total_SRHmod_1026))) %>%  # print a png of this table
  kable_styling() %>%
  save_kable(file = "C:/Users/samjg/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/ClearanceRates/20211026_figs_tables/20211026_Total_CR_SRH_Table.png", zoom = 1.5)
