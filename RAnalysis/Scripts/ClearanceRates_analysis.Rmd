...
Ply_LMERmod_0914 <- lmer(CR_mL.hr.mmlength ~ pH + (1|random_fact), data=Ply_FR_914_df, REML = FALSE) # lme4 (can run leenes test with this package output)
...
# | &nbsp; | Sum Sq | Mean Sq | NumDF | DenDF | F value | Pr(>F)  |
# |:------:|:------:|:-------:|:-----:|:-----:|:-------:|:-------:|
# | **pH** | 21.08  |  21.08  |   1   |  21   |  4.102  | 0.05573 | # marginal effect!
...
shapiro.test(resid(Seston_LMEmod_1026)) #  2.236e-06
