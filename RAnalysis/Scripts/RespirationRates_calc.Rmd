...
bLength_all      = 2.13 #  the scaling exponent that we found for all our cumulative F1 data- also a similar b factor for SMO and length found in literature  (2.199)
