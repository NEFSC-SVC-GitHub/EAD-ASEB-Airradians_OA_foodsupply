...
Resp.Master_OM$resp_µmol_L_m_Length_hr <- (Resp.Master_OM$resp_umol_L_hr / # multiple by 1000 to convert mmol/ O2 to umol/L O2
...
# Export to pdf
pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/RawRespiration_by_WholeDW.pdf"), width = 10, height = 6)
ggarrange(P_WholeDW_resp_all, P_WholeDW_resp_facet,ncol = 2) 
dev.off()
...
# Export to pdf
pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/RawRespiration_by_Length.pdf"), width = 10, height = 6)
...
ggarrange(Resp_LengthStand,
  ...
  ggexport(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/All_Respiration_normalized.pdf")


pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/All_Respiration_normalized_summary.pdf"), width = 10, height = 6)
...
Resp_0914 %>% summarySE(measurevar="resp_µmol_L_m_Length_hr", groupvars=c("pH")) %>% 
...
ggarrange(Resp914_Length,Resp914_Length_reps,nrow = 2) %>%
  ggexport(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/20210914_figs_tables/20210914_respiration_length.standardized.pdf")
...
Resp_0930 %>% summarySE(measurevar="resp_µmol_L_m_Length_hr", groupvars=("pH")) %>% 
      dplyr::mutate(pCO2 = case_when(pH == 8  ~ "500 μatm", pH == 7.5 ~ "800 μatm"))
```
...
require(nlme)
# Linear mixed effects model with random effect of Replicate 
LMEmod_1026_SL<-lme(resp_µmol_L_mm_Length_hr ~ pCO2 * Food, random=~1|Chamber_tank, data=Resp_1026)
...
kable(as.data.frame(anova(LMEmod_1026_SL))) %>% 
  kable_styling() %>%
  save_kable(file = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/20211026_figs_tables/20211026_resp_LME_Table.png", zoom = 1.5)
pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/20211026_figs_tables/20211026_resp_LME_Diagnostics.pdf"))
...
lsmeans(LMEmod_1026_SL, pairwise~pCO2 * Food, adjust="tukey") # Compute least-squares means
 ...
 # 500 µatm fed - 800 µatm fed     -5.74e-05 8.93e-06  6  -6.430  0.0027
 # 500 µatm fed - 500 µatm unfed    9.03e-05 9.41e-06 24   9.589  <.0001
 # 500 µatm fed - 800 µatm unfed    9.08e-05 9.41e-06  6   9.640  0.0003
 # 800 µatm fed - 500 µatm unfed    1.48e-04 8.93e-06  6  16.538  <.0001
 # 800 µatm fed - 800 µatm unfed    1.48e-04 8.93e-06 24  16.592  <.0001
 # 500 µatm unfed - 800 µatm unfed  4.82e-07 9.41e-06  6   0.051  0.9999
...
denisty_box_resp_92DPF <-ggplot(p.box.data) +
                            ...
                            geom_point(data = . %>% unnest(outliers), aes(x = outliers, y = -0.15)) +
...
pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA-foodsupply/RAnalysis/Output/Respiration/20211026_figs_tables/20211026_resp_density_plot.pdf"), width = 5, height = 8)
