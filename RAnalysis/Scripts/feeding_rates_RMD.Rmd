...
for (i in 1:nrow(loop_BLANKS)) { # for each unique identifier....
  ...
  dat <- Blanks.Master %>% 
    ...
    if (  min(dat$PLY_cell.ml[c(t_end_min1:t_end)])  <   C0_Ply) { # if the minmum value of the last three timepoints is less than the concentration at time 0....
    ...
    if (  min(dat$Chaet_cell.ml[c(t_end_min1:t_end)])  <   C0_Ply) { # if the minmum value of the last three timepoints is less than the concentration at time 0....
    ...
    if (  min(dat$Low_chlorophyll_cell.ml[c(t_end_min1:t_end)])  <   C0_Ply) { # if the minmum value of the last three timepoints is less than the concentration at time 0....
...
# |:---------------:|:-----:|:-----:|:-------:|:---------:|
# | **(Intercept)** |   1   |  10   |  44.42  | 5.602e-05 |
# |     **pH**      |   1   |   6   | 0.8047  |  0.4042   |
...
# |     &nbsp;      | numDF | denDF | F-value |  p-value  |
# |:---------------:|:-----:|:-----:|:-------:|:---------:|
# | **(Intercept)** |   1   |  15   |  61.29  | 1.122e-06 |
# |     **pH**      |   1   |   6   |  3.563  |   0.108   |
...
# |     &nbsp;      | numDF | denDF | F-value |  p-value  |
# |:---------------:|:-----:|:-----:|:-------:|:---------:|
# | **(Intercept)** |   1   |  13   |  50.02  | 8.384e-06 |
# |     **pH**      |   1   |   6   | 0.6278  |  0.4583   |
...
# |      &nbsp;      | numDF | denDF | F-value |  p-value  |
# |:----------------:|:-----:|:-----:|:-------:|:---------:|
# | **(Intercept)**  |   1   |  23   |  22.21  | 9.522e-05 |
# |      **pH**      |   1   |   9   | 0.0902  |  0.7707   |
# |  **Fed_Unfed**   |   1   |   9   | 0.7314  |  0.4146   |
# | **pH:Fed_Unfed** |   1   |   9   |  1.277  |  0.2877   |
