...
df_total.930$pCO2 <- as.factor(df_total.930$pH)
levels(df_total.930$pCO2) <- c("Low", "High")
...
pdf(paste0("C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_OA/RAnalysis/Output/FeedingRates/ClearanceRate_2010930_boxplot.pdf"))
CR_930_boxplot
dev.off()
