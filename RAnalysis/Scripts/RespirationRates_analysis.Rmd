...
# |:-------------:|:--:|:--------:|:--------:|:-------:|:------:|
# |   **pCO2**    | 1  | 0.002212 | 0.002212 | 0.4551  | 0.508  |
# | **Residuals** | 19 | 0.09232  | 0.004859 |   NA    |   NA   |
# output results 
...
# check model assumptions
shapiro.test(residuals(AOV930.bfactALL)) # non-normal - 0.0001944
...
# |       &nbsp;       | Df | Sum Sq |   H    | p.value |
# |:------------------:|:--:|:------:|:------:|:-------:|
# |      **pCO2**      | 1  | 295.2  | 0.8257 | 0.3635  |
# |   **Fed_Unfed**    | 1  |  1383  | 3.867  | 0.04923 |
# | **pCO2:Fed_Unfed** | 1  | 405.7  | 1.135  | 0.2867  |
# |   **Residuals**    | 61 | 20773  |   NA   |   NA    |
# output results 
...
# check model assumptions
shapiro.test(residuals(AOV1026.bfactALL)) # normal - 0.8054
leveneTest(AOV1026.bfactALL) # homogeneity of variance (equal variance) - 0.01797 *
# run non parametric
...
# food supply diff - report this percent difference alonside the significant effect
Resp_1026 %>% summarySE(measurevar="resp_umol_hr_bFactorNormLength", groupvars="Fed_Unfed")
perc_diff <- (0.07824169 - 0.05393284)/0.07824169*100
perc_diff #31.06892 %
